...
if (isset($_GET['id'])) {
    ...
    if ($id > 0) {
        //REQUETE SQL POUR RECUPERER L'éditeur EN BDD
        // $sql = "SELECT * FROM contact WHERE id = " . $_GET['id'];
        $sql = "SELECT * FROM editeur WHERE id = ?"; //? parce qu'on a qu'une valeur, si plusieurs mettre les flags ex :id, :nom etc
...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="container">
                <h1 class="text-center">Modifier un éditeur</h1>

                <?php if (isset($_SESSION['error_update_editeur']) && ($_SESSION['error_update_editeur'] == true)) {
                    alert('danger', "l'éditeur est non modifié");
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="ville" class="form-control" id="ville" value="<?= $editeur['ville'] ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="mail" class="form-control" id="mail" value="<?= $editeur['mail'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="numero_tel" class="form-label">Numero :</label>
                        <input type="text" name="numero_tel" class="form-control" id="numero_tel" value="<?= $editeur['numero_tel'] ?>">
                    </div>
