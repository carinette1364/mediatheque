...
<body id="page-top">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <?php
            // var_dump($_SESSION);
            if (isset($_SESSION['error_add_categorie']) && ($_SESSION['error_add_categorie'] == true)) {
                alert('danger', "la categorie n'est pas ajoutée");
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="btn d-flex mx-auto" style="width: 200px">
                        <div class="mb-3 text-center">
                            <input type="submit" name="btn_add_categorie" class="btn btn-primary mx-3" value="Ajouter">
                        </div>
                        <div class="mb-3 text-center">
